    ...
    return (
        <header className="header">
            ...
            <div className="header__player"> 
                <img src="https://www.last.fm/static/images/defaults/player_default_album.430223706b14.png" alt=""></img>
            </div>

            <div className="header__logo">
                <a href="./" className="header__link">
                    <img src="https://www.last.fm/static/images/logo_animate.e1b8206ad4c7.gif" alt=""></img>
                </a>
            </div>
